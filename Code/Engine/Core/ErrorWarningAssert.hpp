...
__declspec(noreturn) void FatalError(const char* file_path, const char* function_name, int line_num,
	const std::string& reason_for_error, const char* condition_text = nullptr);
void RecoverableWarning(const char* file_path, const char* function_name, int line_num,
	const std::string& reason_for_warning, const char* condition_text = nullptr);
void SystemDialogue_Okay(const std::string& message_title, const std::string& message_text, SeverityLevel severity);
bool SystemDialogue_OkayCancel(const std::string& message_title, const std::string& message_text, SeverityLevel severity);
bool SystemDialogue_YesNo(const std::string& message_title, const std::string& message_text, SeverityLevel severity);
int SystemDialogue_YesNoCancel(const std::string& message_title, const std::string& message_text, SeverityLevel severity);
